...
# installed.
TCL_PREFIX='D:/Anaconda/envs/NarrativeConda\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='D:/Anaconda/envs/NarrativeConda\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='D:/Anaconda/envs/NarrativeConda\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-ID:/Anaconda/envs/NarrativeConda\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LD:/Anaconda/envs/NarrativeConda\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='D:/Anaconda/envs/NarrativeConda\Library\lib\tclstub86.lib'
